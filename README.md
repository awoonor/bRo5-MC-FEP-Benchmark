...
> Structural datasets for the large-scale retrospective affinity prediction of 240 macrocyclic ligands across five diverse targets (KRAS, PCSK9, MCL-1, JAK2, Cyclin A/B).
...
### Repository Contents
* `inputs/`: Contains the protein receptor structures (`.pdb`) and the aligned, 3D-generated macrocyclic ligands (`.sdf`).
...
> E.A.-W., et al. "De-risking Affinity Optimization for Macrocycles and Cyclic Peptides: High Precision Free Energy Simulations across Five Diverse Targets", *Submitted*, 2026.
